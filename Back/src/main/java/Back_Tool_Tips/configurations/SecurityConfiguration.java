package Back_Tool_Tips.configurations;
...
public class SecurityConfiguration {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        // Si vous voulez désactiver complètement un en-tête (comme X-Content-Type-Options)
        // la syntaxe est :
        // .headers(headers -> headers.contentTypeOptions(config -> config.disable()))
